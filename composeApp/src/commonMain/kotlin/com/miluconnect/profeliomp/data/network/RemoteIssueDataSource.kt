...
interface RemoteIssueDataSource {
    suspend fun getAllIssues(): Result<List<IssueDto>, DataError.Remote>
    suspend fun createNewIssue(newIssue: Issue): Result<IssueDto, DataError.Remote>
}
...
class RemoteIssuesDataSourceImpl(
    ...
    override suspend fun getAllIssues(): Result<List<IssueDto>, DataError.Remote> {
        return makeRequest(
            requireAuth = true,
    ...
    override suspend fun createNewIssue(newIssue: Issue): Result<IssueDto, DataError.Remote> {
        return makeRequest(
            requireAuth = true,
