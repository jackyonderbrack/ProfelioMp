...
interface LoginRepository {
    suspend fun login(loginPayload: LoginPayload): DataResult<LoginResponse, DataError.Remote>
}
...
class LoginRepositoryImpl (
    ...
    override suspend fun login(loginPayload: LoginPayload): DataResult<LoginResponse, DataError.Remote> {
